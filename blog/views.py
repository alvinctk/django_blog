...
class PostListView(ListView):
    """
    Class-based view is analogous to the the post_list view. 
    """
...
def post_share(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message += "{}'s comments: {}".format(cd['name'], cd['comments'])
            send_mail(subject, message, 'alvinctk@gmail.com', [cd['to']])
            sent = True
    else:
        form = EmailPostForm()
